...
<div id="header">
	...
	</div>	<!-- header góra i logowanie koniec -->
	 ...
	 <!--tresc bloga-->
		...
		<div class="log col-xs-12">
			...
			<div id='komulna-2' class='kolumna-2 col-xs-6 col-xs-offset-3'>
				...
				<!-- komunikaty o poprawnym i błednym działaniu -->
			<?php 
			...
			<!--informacje adm koniec-->
			<!--1 panel - kolonie zaakceptować -->
			...
			<?php
                      ...
                      <?php } ?>
<!--1 panel - kolonie zaakceptować koniec -->
...
<input type="reset" style="width:100%; " value="Wyczyść"/><br />
		   ...
		   <!---dodaj kolonie koniec--->
		   
		    <!---2 panel - półkolonie---><!--dodaj półkolonie--> <!--dodaj półkolonie koniec--><!---2 panel - półkolonie koniec--->
		    <!---3 panel - obozy  ---><!--dodaj obozy językowe--><!--dodaj obozy językowe koniec ---><!---3 panel - obozy koniec--->
 ...
 <!--lista uzytkowników-->
	 ...
	 <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
			...
			<?php  } ?>
			  	 ...
			  	 <!--lista uzytkowników koniec-->
				  <!--przycisk wyloguj -->
            <!---koniec panela administratora---->
			...
			<?php } ?>
				...
				<!---informacje użtytkownik koniec---->		
					
			
			<!-----dostepne kolonie uzytkownik ------>
			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
              <div class="panel panel-default">
                ...
                <div id="collapse9" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading9">
				  ...
				  <!-----dostepne polkolonie uzytkownik------>
			...
			<?php  } ?>
			  ...
			  <!-----1panel uzytkownik - kolonie  koniec---->
			  
			  <!----2 panel uzytkownik - polkolonie-->
			 <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
              <div class="panel panel-default">
			...
			<?php  } ?>
			   ...
			   <!----2 panel uzytkownik - polkolonie koniec-->
			  <!----3 panel uzytkownik - obozy jezykowe-->
			 <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
              <div class="panel panel-default">
...
<!----3 panel uzytkownik - obozy jezykowe koniec-->
			...
			<?php } ?>
			  ...
			  <!---Informacje organizator koniec---> 
			  
			  <!--- 1 panel twoje kolonie organizator ---->
			  <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
              <div class="panel panel-default">
                <div class="panel-heading" role="tab" id="heading9">
                  <h4 class="panel-title">
			  ...
			  <!--- 1 panel twoje kolonie organizator koniec ---->
			  
			  <!--- 2 panel twoje polkolonie organizator ----><!--- 2 panel twoje polkolonie organizator koniec---->
			  <!--- 3 panel twoje obozy organizator ----><!--- 3 panel twoje obozy organizator koniec---->
			  
			  <!---Dodaj kolonie organizator ---> 
...
<input type="reset" style="width:100%; " value="Wyczyść"/><br />
			  ...
			  <!---Dodaj kolonie organizator koniec ---> 
			  <!---Dodaj polkolonie organizator ---> <!---Dodaj polkolonie organizator koniec---> 
			  <!---Dodaj obozy organizator ---> <!---Dodaj obozy organizator koniec ---> 
