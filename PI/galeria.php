	   ...
	   <div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="carousel-item active">
					<img src="img/nag-galeria.jpg" alt="" style="margin: 0px auto;">
				</div> 
...
<div id="container" class="container">
		...
		<div class="onas col-xs-12">
				<div class="header col-xs-12 no-padding">
				<div id="tyt1">
		            <h2 class="text-center text-uppercase">Galeria</h2>
		        </div></div>
	...
	<div class='row'>
		<div class="content-prawa container-fluid">
                      

                      <div class="content-prawa col-xs-12 nopadding">
					  
					  <div class="title col-xs-12 no-padding">
		            <h3 class="text-center">Kolonie 2017 - sezon letni</h3></div>
					  
					  
                        <div class="rzecz col-lg-4 rzecz1">
                          <div class="rzecz-content col-xs-12">
                            <div class="nazwa">
                              <h4 class="text-center">Świnoujście - Wakacyjny Relax</h4>
                            </div>
                            
                              <img src="img/gal1.jpg" class="img-responsive">
                            
                            <div class="turn col-xs-12">
							<div id="turnus">
							<p class="text-center">Turnus:<span> 26.06-10.07.2017</span></p></div>
                              <p class="text-center"><a href="#">Więcej informacji »</a></p>
                            </div>
                          </div>
                        </div>
                        <div class="rzecz col-lg-4 rzecz2">
                        <div class="rzecz-content col-xs-12">
                          <div class="nazwa">
                            <h4 class="text-center">Kołobrzeg - Wakacyjny Relax</h4>
                          </div>
                          <div class="img">
                            <img src="img/gal2.jpg" class="img-responsive">
                          </div>
                          <div class="turn col-xs-12">
						  <div id="turnus">
                            <p class="text-center">Turnus: <span>10-24.07.2017</span></p></div>
                            <p class="text-center"><a href="#">Więcej informacji »</a></p>
                          </div>
                        </div>
                        </div>
                        <div class="rzecz col-lg-4 rzecz3">
                        <div class="rzecz-content col-xs-12">
                          <div class="nazwa">
                            <h4 class="text-center">Rabka Zdrój - Wakacyjny Relax</h4>
                          </div>
                          <div class="img">
                            <img src="img/gal3.jpg" class="img-responsive">
                          </div>
                          <div class="turn col-xs-12">
						  <div id="turnus">
                            <p class="text-center">Turnus: <span>10-24.07.2017</span></p></div>
						...
						<div class="title col-xs-12 no-padding">
		            <h3 class="text-center">Kolonie 2017 - sezon zimowy</h3></div>
						
						
						<div class="rzecz col-lg-4 rzecz1">
                          <div class="rzecz-content col-xs-12">
                            <div class="nazwa">
                              <h4 class="text-center">Wisła - Zimowisko z survivalem dla dzieci</h4>
                            </div>
                            
                              <img src="img/gal10.jpg" class="img-responsive">
                            
                            <div class="turn col-xs-12">
							<div id="turnus">
							<p class="text-center">Turnus:<span> 26.01-10.02.2017</span></p></div>
                              <p class="text-center"><a href="#">Więcej informacji »</a></p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="rzecz-content col-xs-12">
                          <div class="nazwa">
                            <h4 class="text-center">Białka Tatrzańska - Zimowa Przygoda</h4>
                          </div>
                          <div class="img">
                            <img src="img/gal11.jpg" class="img-responsive">
                          </div>
                          <div class="turn col-xs-12">
						  <div id="turnus1">
                            <p class="text-center">Turnus: <span>10-24.02.2017</span></p></div>
                            <p class="text-center"><a href="#">Więcej informacji »</a></p>
                          </div>
                        </div>
                        </div>
                        ...
                        <div class="rzecz-content col-xs-12">
                          <div class="nazwa">
                            <h4 class="text-center">Włochy - Veneto - Narciarska podróż</h4>
                          </div>
                          <div class="img">
                            <img src="img/gal133.jpg" class="img-responsive">
                          </div>
                          <div class="turn col-xs-12">
						  <div id="turnus">
                            <p class="text-center">Turnus: <span>10-24.03.2017</span></p></div>
                            <p class="text-center"><a href="#">Więcej informacji »</a></p>
                          </div>
                        </div>
                        </div>
						...
						<div class="title col-xs-12 no-padding">
		            <h3 class="text-center">Półkolonie 2017 - sezon letni</h3></div>
						
						
                        <div class="rzecz col-lg-4 rzecz4">
                        <div class="rzecz-content col-xs-12">
                          <div class="nazwa">
                            <h4 class="text-center">Kolorowe lato - Szczecin</h4>
                          </div>
                          <div class="img">
                            <img src="img/gal4.jpg" class="img-responsive">
                          </div>
                          <div class="turn col-xs-12">
						  <div id="turnus">
                            <p class="text-center">Turnus: <span>24.07-31.07.2017</span></p></div>
                            <p class="text-center"><a href="#">Więcej informacji »</a></p>
                          </div>
                        </div>
                        </div>
                        <div class="rzecz col-lg-4 rzecz5">
                        <div class="rzecz-content col-xs-12">
                          <div class="nazwa">
                            <h4 class="text-center">Kraków - Smocza Jama</h4>
                          </div>
                          <div class="img">
                            <img src="img/gal5.jpg" class="img-responsive">
                          </div>
                          <div class="turn col-xs-12">
						  <div id="turnus">
                            <p class="text-center">Turnus: <span>10-18.07.2017</span></p></div>
                            <p class="text-center"><a href="#">Więcej informacji »</a></p>
                          </div>
                        </div>
                        </div>
                        <div class="rzecz col-lg-4 rzecz6">
                        <div class="rzecz-content col-xs-12">
                          <div class="nazwa">
                            <h4 class="text-center">Wrocław - Zabawa w mieście</h4>
                          </div>
                          <div class="img">
                            <img src="img/gal6.jpg" class="img-responsive">
                          </div>
                          <div class="turn col-xs-12">
						  <div id="turnus">
                            <p class="text-center">Turnus: <span>31.07-7.08.2017</span></p></div>
                            <p class="text-center"><a href="#">Więcej informacji »</a></p>
                          </div>
                        </div>
                        </div>
						...
						<div class="title col-xs-12 no-padding">
		            <h3 class="text-center">Obozy językowe 2017 - sezon letni</h3></div>
						
						
                        <div class="rzecz col-lg-4 rzecz7">
                        <div class="rzecz-content col-xs-12">
                          <div class="nazwa">
                            <h4 class="text-center">English for Youth - Rzeszów</h4>
                          </div>
                          <div class="img">
                            <img src="img/gal7.jpg" class="img-responsive">
                          </div>
                          <div class="turn col-xs-12">
						  <div id="turnus">
                            <p class="text-center">Turnus: <span>7-14.08.2017</span></p></div>
                            <p class="text-center"><a href="#">Więcej informacji »</a></p>
                          </div>
                        </div>
                        </div>
                        <div class="rzecz col-lg-4 rzecz8">
                        <div class="rzecz-content col-xs-12">
                          <div class="nazwa">
                            <h4 class="text-center">Rymanów Zdrój - English for Kids</h4>
                          </div>
                          <div class="img">
                            <img src="img/gal8.jpg" class="img-responsive">
                          </div>
                          <div class="turn col-xs-12">
						  <div id="turnus">
                            <p class="text-center">Turnus: <span>31.07-7.08.2017</span></p></div>
                        ...
                        <div class="rzecz col-lg-4 rzecz9">
                        <div class="rzecz-content col-xs-12">
                          <div class="nazwa">
                            <h4 class="text-center">Kamionka - English Time</h4>
                          </div>
                          <div class="img">
                            <img src="img/gal9.jpg" class="img-responsive">
                          </div>
                          <div class="turn col-xs-12">
						  <div id="turnus">
                            <p class="text-center">Turnus: <span>26.06-10.07.2017</span></p></div>
