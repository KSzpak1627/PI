	   ...
	   <div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="carousel-item active">
					<img src="img/nag-onas.jpg" alt="" style="margin: 0px auto;">
				</div> 
...
<div id="container" class="container">
		...
		<div class="onas col-xs-12">
				...
				<div id="tyt1">
		            <h2 class="text-center text-uppercase">O nas</h2></div>
		        </div>
				<div class="blog-wpis col-xs-12">
		            ...
		            <h3 class="text-center">Centrum Kolonii, Półkolonii i Obozów Językowych dla Dzieci i Młodzieży</h3>
							...
							<div class="text1 col-xs-12 no-padding">
					<h4 class="text-center">
					<p>Turystyką i wypoczynkiem Państwa dzieci zajmujemy się od 2010 roku, nieustannie podnosząc nasze kwalifikacje, 
					<p>dopracowując nasze oferty i kadrę oraz dbając o Państwa satysfakcję z naszych usług.</p>
					<br></br>
					
					<p>Prezentowane przez nas oferty to zbiór najlepszych kolonii, półkolonii oraz obozów językowych gwarantujących 
					<p>najwyższy standard obsługi, dbałość o bezpieczeństwo, atrakcyjność programu oraz satysfakcje Rodzica i dziecka. </p>
					<br></br>
					
					<p>Nasza firma zajmuje się organizacją wyjazdów dla dzieci i młodzieży w sezonach letnich i zimowych oraz 
					<p>pośredniczy pomiędzy samodzielnymi organizatorami a uczestnikami. Posiadamy bogatą i różnorodną ofertę wyjazdów 
					<p>dopasowaną do upodobań i umiejętności Państwa dzieci. Wyjazdy kolonijne, półkolonijne i obozy językowe organizowane 
					<p>są w ramach naszego kraju jak i zagranicy.</p>
					<br></br>
					
					<p>Kolonie i obozy językowe odbywają się w kurortach morskich, uzdrowiskach i miastach górskich. Zapewniamy bogate 
					<p>i intersujące programy, wykwalifikowaną kadrę i równowagę pomiędzy zabawą i nauką. Ponadto, półkolonie odbywają 
					<p>się w wielu Państwa miastach i trwają do godziny 17.  </p>
					<br></br>
					
					<p>Nasza firma stara się pomóc na każdym etapie rezerwacji wyjazdu, od wyboru do kupna, ponadto chętnie staramy się
					<p>dobrać idealny wyjazd dla Państwa dziecka.  </p>
					<br></br>
					
					
					<p>W naszej ofercie na pewno znajdą Państwo różnorodne i bogate w atrakcje wyjazdy, o których marzy Państwa dziecko.</p>
					<br></br>
					<p>W razie jakichkolwiek pytań zapraszamy do kontaktu z nami! </p>
					<br></br>
					</h4></div>
							...
							<div class="title col-xs-12 no-padding">
		            <h3 class="text-center">Nasi pracownicy</h3></div>
          ...
          <div class="col-lg-4">
            <img class="rounded-circle" src="img/onas1.jpg" height="140" width="140">
            <h2>Michał Nowak</h2>
            <p>Dyrektor Generalny</p>
			<p>Telefon: 513 398 987
			<p>E-mail: m.nowak@gmail.com</p>
			</p></p>
            <p><a class="btn btn-secondary" href="m.nowak@gmail.com" role="button">Skontaktuj się »</a></p>
          </div>
          <div class="col-lg-4">
            <img class="rounded-circle" src="img/onas2.jpg" height="140" width="140">
            <h2>Anna Kot</h2>
            <p>Manager ds. Sprzedaży Wyjazdów</p>
            <p>Telefon: 533 305 541</p>
			<p>E-mail: akot@gmail.com</p>
            <p><a class="btn btn-secondary" href="akot@gmail.com" role="button">Skontaktuj się »</a></p>
          </div>
          <div class="col-lg-4">
            <img class="rounded-circle" src="img/onas3.jpg" height="140" width="140">
            <h2>Karolina Dyjak</h2>
			<p>Specjalista ds. Organizacji Wyjazdów</p>
			<p>Telefon: 515 212 449</p>
			<p>E-mail: kdyjak@gmail.com</p>            
            <p><a class="btn btn-secondary" href="kdyjak@gmail.com" role="button">Skontaktuj się »</a></p>
          </div>
        </div>
