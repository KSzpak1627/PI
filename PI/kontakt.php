	   ...
	   <div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="carousel-item active">
					<img src="img/nag-kontakt.jpg" alt="" style="margin: 0px auto;">
				</div> 
...
<div id="container" class="container">
		...
		<div class="kont col-xs-12">
				...
				<div id="tyt1">
		            <h2 class="text-center text-uppercase">Kontakt</h2></div>
		        </div>
				<div class="blog-wpis col-xs-12">
		            ...
		            <h3 class="text-center">Centrum Kolonii, Półkolonii i Obozów Językowych dla Dzieci i Młodzieży</h3></div>
					
					<div class="text1 col-xs-12 no-padding">
					<h4 class="text-center">
					<p>al. W. Sikorskiego 54b</p>
					<p>35-650 Rzeszów</p>
					<p>tel.
					<a href="tel:+48178721000" title="Telefon"> +48 17 654 90 10</a>
					<p>email:
					<a href="centrumkolonii@gmail.com" title="Email">centrumkolonii@gmail.com</a></p>
					
					</h4></div>
					
					 
<div class="header col-xs-12 no-padding">
		            <h5 class="text-center">Masz do nas pytanie? Wyślij wiadomość:</h5></div>
...
?>
<form id="formularz" method="post" action="kontakt.php"> 

<br />
<input type="text" name="imie" placeholder="Imię" style="width:30%"/><br />
<br />
<input type="text" name="nazwisko" placeholder="Nazwisko" style="width:30%"/><br />
<br />
<input type="text" name="email" placeholder="E-mail" style="width:30%;"/><br />
<br />
<input type="text" name="temat" placeholder="Temat" style="width:30%;"/><br />
<br />
<textarea name="mail" cols="30" rows="5" placeholder="Treść wiadomości" style="width:30%;"></textarea><br />
<input type="submit" name="submit" style="width:30%; " value="Wyślij wiadomość"/> <br />
<input type="reset" style="width:30%; " value="Wyczyść"/><br />
</form>

<?php
}elseif(!empty($_POST['imie']) && !empty($_POST['nazwisko']) && !empty($_POST['email']) && !empty($_POST['mail'])){
	
function poprawnosc($email) {
...
if(poprawnosc($_POST['email'])){
	
$addressmail=$_POST['odbiorca'];
$ip=$_SERVER['REMOTE_ADDR'];
$charset = 'utf-8';
$host=gethostbyaddr($_SERVER['REMOTE_ADDR']);
$wiad="Od: $_POST[imie] $_POST[nazwisko] ($_POST[email])\nIP: $ip, HOST: $host\n\n$_POST[mail]";
$nadawca="From: $_POST[email]";
@mail($addressmail, "Formularz kontaktowy z Centrum Kolonii", "$wiad", "$nadawca");
echo "<span style=\"color: #00D800; font-weight: bold; \">Dziękujemy, wiadomość została wysłana. Nasi pracownicy odpowiedzą na państwa wiadomość w ciągu 24h.</span>";
}else{ echo "<span style=\"color: #FF0000; text-align: center; font-weight: bold;\">Wprowadź poprawny adres e-mail.</span>"; }
}else{ echo "<span style=\"color: #FF0000; text-align: center; font-weight: bold;\">Cofnij i wypełnij wszystkie pola wiadomości.</span>"; }
?>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2564.509063274816!2d22.015343615686266!3d50.001813079416024!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x473cfa141d409c05%3A0x7e0c448488d48fdc!2sUnnamed+Road%2C+35-001+Rzesz%C3%B3w!5e0!3m2!1spl!2spl!4v1510532690848" width="100%" height="400" frameborder="0" style="border:0" allowfullscreen></iframe>
